...
import { signOut } from "./client-BoQ21ulK.mjs";
import { t as FAMILY_ADMIN_EMAILS } from "./admins-BfKTxyPC.mjs";
import { n as useCurrentUserState, t as useCurrentUser } from "./use-current-user-B42il0rW.mjs";
...
import { S as saveSettings, _ as deleteReview, b as getAdminBundle, d as addPhoto, f as addReview, g as deletePhoto, h as deleteMessage, m as addVideo, p as addShow, v as deleteShow, w as updateShow, x as saveAdminEmails, y as deleteVideo } from "./router-ZMc0cNyu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin-DXmyZXwe.js
...
function AdminPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			}), bundle ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				error ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-xl border border-danger/30 bg-surface px-5 py-6",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-display text-xl font-semibold",
							children: "This account cannot update the site"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								children: "Back to the public site"
							})]
						})
					]
				}) : null,
				loading && !bundle && !error ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm text-muted",
...
function ContactTab({ settings, extraAdminEmails, onChange }) {
	const [busy, setBusy] = (0, import_react.useState)(false);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "font-display text-2xl font-semibold",
				children: "Who can update the site"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "mt-2 text-sm leading-relaxed text-muted",
				children: [
					"Always allowed: ",
					FAMILY_ADMIN_EMAILS.join(", "),
					". Add another family email below, one per line, if John uses a different address."
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-4 grid gap-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					...
					type: "submit",
					disabled: busy,
					children: busy ? "Saving…" : "Save family emails"
				})]
			})
		]
	})] });
